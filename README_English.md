...
### Introduction
AetherFantasy Auth is a flexible authentication plugin supporting multiple server types (Paper/Velocity). It provides four authentication modes (local, official, proxy, and custom) to meet player identity verification needs in various scenarios.
...
- Flexible authentication modes: Four authentication methods available:
  ...
  - official: Integrates with official authentication interfaces (following AetherFantasyAuthAPI protocol), perfect for unified account system scenarios.
...
### AetherFantasyAuthAPI Development & Help Manual
- [In Development]()

AetherFantasy Studio\
Skilfully CN
