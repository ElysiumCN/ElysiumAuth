...
### 简介
AetherFantasy Auth 是一款支持多服务端（Paper/Velocity）的灵活认证插件，提供本地、官方、代理及自定义四种认证模式，适配不同场景下的玩家身份验证需求。
...
- 灵活认证模式：提供 4 种认证方式：
  ...
  - official：对接官方认证接口（遵循 AetherFantasyAuthAPI 协议），适合需要统一账号体系的场景。
